...
- **WHEN** sanitized runtime label provenance metadata is available from an authorized A100 execution
...
- **THEN** they MUST state whether real tokenizer/collator labels were inspected and MUST NOT claim model recovery, held-out generalization, checkpoint release, adapter release, production readiness, public full-corpus release, or live-browser benchmark improvement
