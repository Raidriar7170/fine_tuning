...
- 仍未合入 formal public sample，当前 manifest 仍是 `public-sample-20260617T045941Z`；
...
standalone candidates 也已经 materialize。当前最新下一步应是一个后续
bounded review/merge-design phase，用这些 standalone candidates 创建新的 formal
manifest boundary；在那之前不应直接继续训练、改 evaluator、引入 DPO 或宣称模型恢复。
