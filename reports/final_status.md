...
| Latest canonical slot-boundary row-level candidate materialization recommended next step | later formal merge review/apply phase can inspect this source; direct merge is not implemented now |
