# A100 public held-out residual repair dev alignment diagnostics
...
- `normalized_command` (value_mismatch): gold string(6): 打开示例网站; prediction string(14): 访问 example.com
...
- `normalized_command` (value_mismatch): gold string(6): 请求澄清目标; prediction string(8): 帮我搜索相关内容
...
- `confirmation_required` (value_mismatch): gold bool: True; prediction bool: False
- `slots` (value_mismatch): gold object with keys: ambiguity; prediction empty object
- `normalized_command` (value_mismatch): gold string(6): 请求澄清目标; prediction string(6): 帮我查找那个
