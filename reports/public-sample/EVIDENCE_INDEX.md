...
| CURRENT | analyze-slot-error-mechanisms-and-design-slot-representation | recovered step-matched slot-level residual analysis | `MIXED_SLOT_REPRESENTATION_REQUIRED`; exact/normalized source-copyable 50.53%; typed-derivable 0.00%; generation-required 49.47%; next change `design-hybrid-slot-representation-v1`. | - | `reports/public-sample/slot-error-mechanism-analysis/summary.json` |
