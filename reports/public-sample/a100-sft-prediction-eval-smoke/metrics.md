# A100 SFT private-adapter prediction/eval smoke metrics
...
- `schema`: 12 examples (seed-search-weather, seed-search-weather-aug-1, seed-search-weather-aug-2, seed-open-example, seed-open-example-aug-1)
